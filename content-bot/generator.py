...
- Длина каждого варианта: 350–500 символов (это половина обычной длины из tone-of-voice.md — короче и плотнее)
...
_LIFEHACK_INSTRUCTION = (
    ...
    "которую читатель может применить прямо сейчас. Длина 500–900 символов (половина обычной).\n"
)
...
_STRUCTURE_SYSTEM = (
    ...
    "Никогда не используй символ \" внутри полей title/description — только « » или ' '."
)
