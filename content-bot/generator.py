...
- Определи целевую аудиторию: «Собственник/управляющий» или «Маркетолог/РОП»
- Пост только про ИИ/автоматизацию — без тем продажи бизнеса, инвестиций, M&A, капитализации объекта
...
[
  {{"variant": 1, "audience": "Собственник/управляющий", "format": "...", "text": "..."}},
  {{"variant": 2, "audience": "Маркетолог/РОП", "format": "...", "text": "..."}},
  {{"variant": 3, "audience": "Собственник/управляющий", "format": "...", "text": "..."}}
]"""
