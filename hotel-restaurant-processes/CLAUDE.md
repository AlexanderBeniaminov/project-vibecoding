...
|---|---|---|---|
| Ежедневный (Python) | `30 18 * * *` UTC | 23:30 каждый день | Забирает данные за вчера из iiko → пишет в строки 1–16 листа «Ежедневно» |
| Резервный (Python) | `30 1 * * *` UTC | 06:30 следующий день | Повтор если основной упал (смена закрыта после полуночи) |
