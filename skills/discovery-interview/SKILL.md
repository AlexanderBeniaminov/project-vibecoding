...
description: Deep interview process to transform vague ideas into detailed specs. Works for technical and non-technical users. Use when user wants to start a new project, build something new, has a vague idea, says "I want to build X", "new project", "новый проект", "хочу сделать", "придумал идею", or needs help defining requirements.
user-invocable: true
