...
def _system_prompt() -> str:
    ...
    base_prompt = (
        ...
        "   Дедлайн — только если пользователь назвал его явно, иначе оставь пустым.\n"
        ...
        "ЖЁСТКИЕ ЗАПРЕТЫ:\n"
        "- НЕЛЬЗЯ спрашивать дедлайн если он не назван — записывай задачу сразу с пустым сроком.\n"
...
_TEAM_ALIASES = {
    # Виктор
    "виктор": "Виктор", "виктора": "Виктор", "виктору": "Виктор",
    "виктором": "Виктор", "викторе": "Виктор", "viktor": "Виктор",
    # Евгения / Женя
    "евгения": "Евгения", "евгении": "Евгения", "евгению": "Евгения",
    "евгенией": "Евгения", "евгение": "Евгения",
    "женя": "Евгения", "жени": "Евгения", "женю": "Евгения",
    "жене": "Евгения", "женей": "Евгения",
    # Надежда / Надя
    "надежда": "Надежда", "надежды": "Надежда", "надежде": "Надежда",
    "надежду": "Надежда", "надеждой": "Надежда",
    "надя": "Надежда", "нади": "Надежда", "наде": "Надежда", "надю": "Надежда",
    # Управляющий
    "управляющий": "Управляющий", "управляющего": "Управляющий",
    "управляющему": "Управляющий", "управляющим": "Управляющий",
    "управляющем": "Управляющий",
    # Тех.директор
    "техдиректор": "Тех.директор", "техдиректора": "Тех.директор",
    "техдиректору": "Тех.директор", "тех.директор": "Тех.директор",
    "тех.директора": "Тех.директор", "тех.директору": "Тех.директор",
    "технический директор": "Тех.директор",
    "технического директора": "Тех.директор", "техническому директору": "Тех.директор",
    "техническим директором": "Тех.директор", "техническом директоре": "Тех.директор",
}
...
# Ловит: «Идея для Губахи...», «Заметка для проекта Монблан...», «для губахи...», «Губаха: ...»
_PROJ_RE = re.compile(
...
async def handle_message(message: Message):
    ...
    task_m = _TASK_FOR_RE.search(text) or _TASK_RE.search(text)
    if task_m:
